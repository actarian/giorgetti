<div class="section--form" user-edit>
	<div class="container" *if="user && !success">
		<form class="form" [formGroup]="form" (submit)="onSubmit()" name="form" role="form" novalidate autocomplete="off">
			...
			<div class="listing--form-compact">
				...
				<div control-custom-select [control]="controls.country" label="Paese"></div>
				<div control-text [control]="controls.city" label="Città"></div>
				<div control-text [control]="controls.company" label="Azienda"></div>
				...
				<div control-custom-select [control]="controls.newsletterLanguage" label="Lingua della newsletter" *if="controls.newsletter.value"></div>
	...
	<div class="container" *if="success">
		<div class="title"><span>Modifica completata</span></div>
		<div class="abstract">Dati modificati con successo.</div>
		<div class="abstract" *if="responseMessage" [innerHTML]="responseMessage"></div>
	</div>
</div>
